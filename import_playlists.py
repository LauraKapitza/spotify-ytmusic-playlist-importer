...
def import_playlists():
    ...
    for pl in playlists:
        ...
        # Create new playlist
        playlist_id = ytmusic.create_playlist(pl["name"], f"Imported from Spotify ({pl['owner']})")
        video_ids = []
        ...
        for track in pl["tracks"]:
            ...
            if video_id:
                ...
                print(f"⚠️ Could not find: {track['name']} by {', '.join(track['artists'] if track['artists'] else [])}")
